// ===== GEKKO Classic — Cyberpunk Frog Robot FPS =====

(function () {
  // ===== 1. Boilerplate =====
  var canvas = document.getElementById('fpsc-canvas');
  ...
  var _fb = document.getElementById('fpsc-body');
  ...
  _ovCss.textContent =
    '@keyframes fpscPulse{0%,100%{opacity:.3}50%{opacity:1}}' +
    '.fpsc-scr{position:absolute;top:0;left:0;width:100%;height:100%;display:none;' +
    'flex-direction:column;align-items:center;justify-content:center;gap:0;' +
    'font-family:"Press Start 2P",monospace;text-align:center;box-sizing:border-box;padding:4% 4%}' +
    '.fpsc-scr.on{display:flex}' +
    '.fpsc-blink{animation:fpscPulse 1.8s ease-in-out infinite}' +
    // Key-cap style
    '.fpsc-key{display:inline-block;border:1px solid rgba(0,255,160,0.45);' +
    ...
    '.fpsc-si{display:inline-block;width:14px;height:14px;border:1px solid;' +
    'border-radius:50%;vertical-align:middle;position:relative;box-sizing:border-box}' +
    '.fpsc-si::after{content:"";position:absolute;width:6px;height:6px;border-radius:50%;' +
    'top:50%;left:50%;transform:translate(-50%,-50%);background:currentColor;opacity:.35}' +
    // Button icon (small rounded rect)
    '.fpsc-bi{display:inline-block;width:10px;height:10px;border-radius:3px;' +
    'border:1px solid;vertical-align:middle;box-sizing:border-box}' +
    // Control grid rows
    '.fpsc-cr{display:flex;align-items:center;justify-content:center;gap:10px;margin:2px 0;flex-wrap:wrap}' +
    '.fpsc-ci{display:flex;align-items:center;gap:4px;font-size:5px;color:#aaffcc;white-space:nowrap}' +
    // Logo block
    '.fpsc-logo{background:rgba(5,4,16,0.5);border-top:2px solid #00ffa0;border-bottom:2px solid #00ffa0;' +
    'padding:12px 28px 10px;text-align:center}' +
    '.fpsc-logo-t{font-size:18px;color:#00ffa0;text-shadow:0 0 8px #00ffa080,0 0 18px #00ffa040;letter-spacing:8px}' +
    '.fpsc-logo-sep{width:50%;height:1px;background:linear-gradient(90deg,transparent,#00ffa060,transparent);margin:8px auto 6px}' +
    '.fpsc-logo-sub{font-size:4px;color:#00dcff;letter-spacing:2px;opacity:.65}' +
    // Gameplay HUD hint
    '.fpsc-hud-hint{position:absolute;bottom:3px;right:4px;display:none;align-items:center;gap:3px;' +
    'font-family:"Press Start 2P",monospace;font-size:4px;text-shadow:0 0 4px rgba(0,0,0,0.9)}' +
    '.fpsc-hud-hint.on{display:flex}';
  document.head.appendChild(_ovCss);

  function _mkScr() { var d = document.createElement('div'); d.className = 'fpsc-scr'; _ov.appendChild(d); return d; }

  // --- Control HTML generators ---
  function _pcControls() {
    return '<div class="fpsc-cr">' +
      '<div class="fpsc-ci"><span class="fpsc-key">W</span><span class="fpsc-key">A</span><span class="fpsc-key">S</span><span class="fpsc-key">D</span> MOVE</div>' +
      '<div class="fpsc-ci"><span class="fpsc-key" style="font-size:4px">MOUSE</span> LOOK</div>' +
    '</div><div class="fpsc-cr">' +
      '<div class="fpsc-ci"><span class="fpsc-key" style="font-size:4px">CLICK</span> FIRE</div>' +
      '<div class="fpsc-ci"><span class="fpsc-key" style="font-size:4px">SPACE</span> JUMP</div>' +
      '<div class="fpsc-ci"><span class="fpsc-key" style="font-size:4px">SHIFT</span> DASH</div>' +
    '</div>';
  }
  function _pcControlsPause() {
    return _pcControls() +
    '<div class="fpsc-cr" style="margin-top:2px">' +
      '<div class="fpsc-ci"><span class="fpsc-key" style="font-size:4px">ESC</span> PAUSE</div>' +
    '</div>';
  }
  function _mobControls() {
    return '<div class="fpsc-cr">' +
      '<div class="fpsc-ci"><span class="fpsc-si" style="color:#00ffa0;border-color:rgba(0,255,160,0.45)"></span> MOVE</div>' +
      '<div class="fpsc-ci"><span class="fpsc-si" style="color:#00dcff;border-color:rgba(0,220,255,0.45)"></span> LOOK</div>' +
    '</div><div class="fpsc-cr">' +
      '<div class="fpsc-ci"><span class="fpsc-bi" style="border-color:#ff3c3c;background:rgba(255,60,60,0.15)"></span> FIRE</div>' +
      '<div class="fpsc-ci"><span class="fpsc-bi" style="border-color:#00ffa0;background:rgba(0,255,160,0.15)"></span> JUMP</div>' +
      '<div class="fpsc-ci"><span class="fpsc-bi" style="border-color:#00dcff;background:rgba(0,220,255,0.15)"></span> DASH</div>' +
    '</div>';
  }
  ...
  _scrTitle.innerHTML =
    '<div class="fpsc-logo">' +
      '<div class="fpsc-logo-t">GEKKO</div>' +
      '<div class="fpsc-logo-sep"></div>' +
      '<div class="fpsc-logo-sub">CYBERPUNK FROG ROBOT</div>' +
    '</div>' +
    '<div style="flex:1 0 14px;max-height:28px"></div>' +
    '<div class="fpsc-blink" style="font-size:8px;color:#fff"></div>' +
  ...
  _scrPause.innerHTML =
    ...
    '<div class="fpsc-blink" style="font-size:7px;color:#fff;margin:14px 0 20px"></div>' +
  ...
  _scrWin.innerHTML =
    ...
    '<div class="fpsc-blink" style="font-size:7px;color:#fff;margin-top:16px"></div>';
  ...
  _hudHint.className = 'fpsc-hud-hint';
  _hudHint.innerHTML = '<span class="fpsc-key" style="font-size:4px;padding:1px 3px">ESC</span><span style="color:#aaffcc">PAUSE</span>';
  ...
  function updateOverlay() {
    ...
    _hudHint.className = 'fpsc-hud-hint' + (showHint ? ' on' : '');

    if (scr === _ovActive) return;
    _ovActive = scr;
    _scrTitle.className = 'fpsc-scr' + (scr === 'title' ? ' on' : '');
    _scrPause.className = 'fpsc-scr' + (scr === 'pause' ? ' on' : '');
    _scrWin.className = 'fpsc-scr' + (scr === 'win' ? ' on' : '');
    _scrDead.className = 'fpsc-scr' + (scr === 'dead' ? ' on' : '');
    var mob = isMobileFps;
    if (scr === 'title') {
  ...
  var fpsWin = document.getElementById('window-fpsc');
  if (fpsWin) {
  ...
  function isFpsActive() {
    var win = document.getElementById('window-fpsc');
  ...
  if (isMobileFps) {
    ...
    var fpsBody = document.getElementById('fpsc-body');
